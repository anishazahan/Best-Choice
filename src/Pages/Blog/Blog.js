            ...
            blogs && blogs.map(blog=>{
                return <div className="flex flex-col lg:flex-row px-5 lg:px-10 mb-10">
                       ...
                       <h2 className='font-xl mb-3 font-bold'>{blog.tittle}</h2>
                        ...
                        <div className="mt-5">
                            <button className=' py-2 overflow-hidden  border  transition-all border-1 border-secondary rounded-sm hover:bg-slate-200 text-secondary font-medium px-10'>Reed More</button>
                        </div>
