      ...
      <div className="login-background relative flex justify-center">
        <div className="login-box bg-white absolute shadow-md pt-10 mt-10 pl-7 pr-10 pb-16 w-[90%] md:w-[70%] lg:w-[35%]">
          ...
          >
            ...
            <button className="py-2 pr-10 pl-5 font-medium">
              {" "}
          ...
          <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
            ...
            <input
              type="submit"
              value="Login"
              className="w-full bg-primary text-white hover:opacity-70 cursor-pointer font-semibold px-4 py-2 mt-3 mb-5"
            />
          </form>
          <div className="flex justify-between">
            <p className="font-medium text-gray-500">New To Best Choice?</p>
            <Link to="/sign-up" className="text-meduim link text-secondary">
              Create New Account
            </Link>
          </div>
        </div>
