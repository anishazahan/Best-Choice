...
<div class="mt-8 mx-auto bg-violet-200 ">
          <div class="grid grid-cols-1 md:grid-cols-2">
            <div class=" p-4 flex flex-col justify-center h-full mx-auto">
              <h1 class="text-3xl sm:text-5xl text-gray-800 font-semibold tracking-tight">Get in touch</h1>
              <p class="text-normal  sm:text-xl font-medium text-gray-600 dark:text-gray-400 mt-2">Fill in the form to submit any query</p>
    
              <div class="flex items-center mt-8 text-gray-600 ">
                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" class="w-8 h-8 text-secondary">
            ...
            <form class="p-6 flex flex-col justify-center">
              ...
              <button type="submit" class="md:w-32 bg-secondary text-white  font-bold py-3 px-6 rounded-sm mt-4 hover:bg-primary  transition ease-in-out duration-300">Submit</button>
            </form>
          </div>
        </div>
